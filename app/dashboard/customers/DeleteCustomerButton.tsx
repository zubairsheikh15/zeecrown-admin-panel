                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-black/50 p-6 text-left align-middle shadow-xl transition-all border border-red-500/30">
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div className="flex-1">
                                            <Dialog.Title as="h3" className="text-lg font-bold leading-6 text-white">Delete Customer</Dialog.Title>
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-400">
                                                    Are you sure you want to delete this customer? This will also remove their authentication account and cannot be undone.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="mt-6 flex justify-end space-x-3">
                                        ...
                                        <form action={async (formData) => { await deleteCustomer(formData); closeModal(); }}>
